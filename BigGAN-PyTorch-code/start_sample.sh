...
--pretrain_path /data1/pretrained_models/138k/D.pth \
--G_pretrain_path /data1/pretrained_models/138k/G_ema.pth \
--data_root /apdcephfs/share_1367250/yuesongtian \
--sample_npz \
--experiment_name hinge_G1-2_D1-1_dgl_finetune_resume \
