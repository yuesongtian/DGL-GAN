...
class GBlock(nn.Module):
  def __init__(self, in_channels, out_channels, arch,
    ...
    # Conv layers
    self.conv1 = OPS[arch['normal_0']](in_channels, out_channels, 1, False) 
    self.conv2 = OPS[arch['normal_1']](out_channels, out_channels, 1, False) 
    ...
    # upsample layers
    self.upsample1 = OPS[arch['up_0']](in_channels, in_channels, 2, False)
    self.upsample2 = OPS[arch['up_1']](in_channels, in_channels, 2, False)
