#!/bin/bash
python3.6 search.py \
--dataset C10 --parallel --shuffle  --num_workers 8 --batch_size 64 --load_in_mem  \
--num_G_accumulations 1 --num_D_accumulations 1 \
--num_D_steps 1 --G_lr 2e-4 --D_lr 2e-4 --D_B1 0.0 --D_B2 0.999 --G_B2 0.999 \
...
--experiment_name search_48ch_C10_bat64_sepWoDeconv_pretrainGbarDbar \
--g_loss loss_hinge_gen --d_loss loss_hinge_dis \
--resume \
--num_epochs 2000 --inner_steps 20 --worst_steps 20 --outer_steps 20 \
